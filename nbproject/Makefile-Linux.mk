...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ./LinuxBinaries/libyaml-cpp.lib

./LinuxBinaries/libyaml-cpp.lib: ${OBJECTFILES}
	${MKDIR} -p ./LinuxBinaries
	${RM} ./LinuxBinaries/libyaml-cpp.lib
	${AR} -rv ./LinuxBinaries/libyaml-cpp.lib ${OBJECTFILES} 
	$(RANLIB) ./LinuxBinaries/libyaml-cpp.lib
